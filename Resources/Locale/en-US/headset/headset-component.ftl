...
chat-radio-message-wrap = [color={$color}]{$channel} [bold][color={$chatColor}]{$name}[/color][/bold] {$verb}, [font={$fontType} size={$fontSize}]"{$message}"[/font][/color]
chat-radio-message-wrap-bold = [color={$color}]{$channel} [bold][color={$chatColor}]{$name}[/color][/bold] {$verb}, [font={$fontType} size={$fontSize}][bold]"{$message}"[/bold][/font][/color]
